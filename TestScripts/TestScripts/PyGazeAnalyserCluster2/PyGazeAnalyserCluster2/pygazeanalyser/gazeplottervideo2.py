"""
This is an old test file altered to create graphs for videos
"""
# native
import os
# external
...
def draw_scanpath(fixations, saccades, dispsize, imagefile=None, alpha=0.5, savefilename=None):
	...
	fix = parse_fixations(fixations)
	# draw fixations
	ax.scatter(fix['x'],fix['y'], s=(1 * fix['dur']*10 ), c=COLS['chameleon'][2], marker='o', cmap='jet', alpha=alpha, edgecolors='none')
